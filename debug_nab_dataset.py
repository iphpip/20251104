...
import numpy as np
import yaml
from data.datasets import NABDataset  # 假设已实现NAB数据集类

def check_nab_ratio(config):
    """检查NAB数据集的异常比例配置合理性"""
    dataset_name = "NAB"
    ...
    try:
        ...
        train_labels = train_set.labels  # 假设labels为ndarray，1=异常，0=正常
